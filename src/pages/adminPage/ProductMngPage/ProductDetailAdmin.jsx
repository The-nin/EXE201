      ...
      try {
        ...
        const response = {
          result: {
            ...
            imageThumbnail:
              "https://via.placeholder.com/600x600/007bff/ffffff?text=Thumbnail",
            status: "ACTIVE",
            ...
            feedbacks: [
              {
                id: 1,
                description:
                  "Chất lượng áo rất tốt, vải mềm mại và thoáng mát. Size vừa vặn như mô tả.",
                rating: 5,
              },
              {
                id: 2,
                description:
                  "Áo đẹp, chất lượng tốt. Giao hàng nhanh. Tuy nhiên màu sắc hơi đậm hơn so với hình ảnh.",
                rating: 4,
              },
              {
                id: 3,
  ...
  return (
    <Container fluid className="py-4">
              ...
              <Row>
                ...
                <Col md={6}>
                  ...
                  <div className="mb-3">
                    ...
                    <p className="mb-0">
                      {product.fabric?.fabricName || "N/A"}
                    </p>
                  </div>
                  <div className="mb-3">
                    <strong>Loại in:</strong>
                    <p className="mb-0">
                      {product.typePrint?.printName || "N/A"}
                    </p>
                  </div>
                  <div className="mb-3">
      ...
      <Tabs defaultActiveKey="details" className="mb-4">
        ...
        <Tab
          eventKey="images"
          title={`Hình ảnh (${product.images?.length || 0})`}
        >
          <Card>
            <Card.Body>
              <Row>
      ...
      <Modal show={showStatusModal} onHide={() => setShowStatusModal(false)}>
        ...
        <Modal.Body>
          <p>
            Bạn có chắc chắn muốn {product.status === "ACTIVE" ? "ẩn" : "hiện"}{" "}
            sản phẩm <strong>"{product.productName}"</strong>?
          </p>
        </Modal.Body>
        <Modal.Footer>
